...
<head>
  ...
  <!-- CDN Bootstrap para que se vea bonito sin configurar assets -->
...
<body class="bg-light">
  <div class="container py-5">
    <div class="card shadow-sm">
      <div class="card-body">
        <h1 id="nombre">María Isabel Vargas Mendoza</h1>
        <!-- se irán agregando secciones en commits siguientes -->
        <!-- dentro del card-body, debajo del h1 -->
        <h3>Origen</h3>
        <p>
